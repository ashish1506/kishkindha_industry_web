      ...
      <div className="container mx-auto px-4 md:px-6 lg:px-8 py-12 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="space-y-4">
            ...
            <p className="text-[#D4A847] font-medium italic">
              &ldquo;Purity in Every Grain&rdquo;
            </p>
            <p className="text-white/80 text-sm leading-relaxed">
              Premium food supplies for businesses across India. Quality ingredients, reliable delivery, competitive pricing.
            </p>
          </div>
            ...
            <ul className="space-y-3">
              <li>
                ...
                >
                  ...
                  <span>support@kishkindhafoods.com</span>
                </a>
              </li>
              <li>
                <a
              ...
              <li>
                ...
                >
                  ...
                  <span>WhatsApp: +91 7042272565</span>
                </a>
              </li>
        ...
        <div className="mt-12 pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-4 pb-4">
          <p className="text-white/60 text-sm">
            &copy; {new Date().getFullYear()} Kishkindha Foods. All rights reserved.
          </p>
          <div className="flex items-center gap-2 text-sm">
            <span className="inline-flex items-center gap-1.5 bg-[#1B4332] px-3 py-1.5 rounded-full">
              ...
              <span className="text-white/90">100% Pure Vegetarian</span>
            </span>
          </div>
        </div>
      </div>
